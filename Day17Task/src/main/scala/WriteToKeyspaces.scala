...
object WriteToKeyspaces extends App {
  ...
  val products = spark.read
    .format("csv")
    .option("header", "true")
    .load("/Users/abhishekanand/IdeaProjects/Day17Task/src/main/scala/Products.csv")

  val customers = spark.read
    .format("csv")
    .option("header", "true")
    .load("/Users/abhishekanand/IdeaProjects/Day17Task/src/main/scala/Customers.csv")

  val sales = spark.read
    .format("csv")
    .option("header", "true")
    .load("/Users/abhishekanand/IdeaProjects/Day17Task/src/main/scala/Sales.csv")
