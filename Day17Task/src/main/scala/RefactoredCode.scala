...
object RefactoredCode extends App {
  ...
  val productsPath = "/Users/abhishekanand/IdeaProjects/Day17Task/src/main/scala/Products.csv"
  val customersPath = "/Users/abhishekanand/IdeaProjects/Day17Task/src/main/scala/Customers.csv"
  val salesPath = "/Users/abhishekanand/IdeaProjects/Day17Task/src/main/scala/Sales.csv"
  ...
  def createSparkSession(): SparkSession = {
    SparkSession.builder
      ...
      .config("spark.cassandra.auth.username", "abhishek_iam-at-767397967709")
      ...
      .config("spark.cassandra.connection.ssl.trustStore.password", "abhi@iit123")
      .getOrCreate()
  }
